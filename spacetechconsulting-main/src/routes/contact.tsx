...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.spacetechconsulting.com/contact" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Contact SpaceTech Consulting" },
      { name: "twitter:description", content: "Book a strategy call with our Yardi platform team." },
