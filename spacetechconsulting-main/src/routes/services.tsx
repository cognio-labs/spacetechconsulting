...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.spacetechconsulting.com/services" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Full-Spectrum Yardi Services | SpaceTech Consulting" },
      { name: "twitter:description", content: "Six service lines covering the complete Yardi lifecycle." },
